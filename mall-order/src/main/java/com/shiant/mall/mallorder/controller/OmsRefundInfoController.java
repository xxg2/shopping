...
import com.shiant.mall.mallorder.service.OmsRefundInfoService;
 ...
 */
@RestController
@RequestMapping("mallorder/omsrefundinfo")
public class OmsRefundInfoController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("mallorder:omsrefundinfo:list")
    ...
    @RequiresPermissions("mallorder:omsrefundinfo:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("mallorder:omsrefundinfo:save")
    ...
    @RequiresPermissions("mallorder:omsrefundinfo:update")
    ...
    @RequiresPermissions("mallorder:omsrefundinfo:delete")
