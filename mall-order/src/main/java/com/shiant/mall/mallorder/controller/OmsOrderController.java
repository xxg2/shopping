...
import com.shiant.mall.mallorder.service.OmsOrderService;
 ...
 */
@RestController
@RequestMapping("mallorder/omsorder")
public class OmsOrderController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("mallorder:omsorder:list")
    ...
    @RequiresPermissions("mallorder:omsorder:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("mallorder:omsorder:save")
    ...
    @RequiresPermissions("mallorder:omsorder:update")
    ...
    @RequiresPermissions("mallorder:omsorder:delete")
